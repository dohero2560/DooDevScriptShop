...
--     resourceName = "your_resource_name", -- ชื่อ resource ของคุณ
--     serverIP = GetConvar("sv_endpoint", "0.0.0.0"), -- Server IP
...
-- -- Verify license when resource starts
-- AddEventHandler('onResourceStart', function(resourceName)
--     if (GetCurrentResourceName() ~= resourceName) then
--         return
--     end
--     print("^3Verifying license...^7")
--     VerifyLicense()
-- end)

-- -- Function to start your resource
-- function StartResource()
--     -- เพิ่มโค้ดการทำงานของ script ที่นี่
...
--     local ipify = "https://api.ipify.org"
--     PerformHttpRequest(ipify, function(errorCode, resultData, resultHeaders)
--         if errorCode == 200 then
--             config.serverIP = resultData -- บันทึก IP ที่ได้
--             print("^2Server IP detected: " .. config.serverIP .. "^7")
--             -- เริ่มการ verify license หลังจากได้ IP
--             VerifyLicense()
--         else
--             print("^1Failed to get server IP. Using fallback IP^7")
--             config.serverIP = GetConvar("sv_endpoint", "0.0.0.0")
--             VerifyLicense()
--         end
--     end, 'GET')
-- end
...
--     GetRealServerIP() -- เริ่มด้วยการดึง IP ที่แท้จริง
-- end)
